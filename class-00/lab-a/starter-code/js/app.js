...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT: // The previous line of code was logging to the console the variable 'rando'. Because the variable rando was declared with let inside the function displayPics(), the console.log will not find the variable 'rando'. When a variable is delcared using let, the scope is only within the BLOCK which the variable is declared. Meaning let rando -- rando will only be defined within the function.{}
  console.log(viewed);
